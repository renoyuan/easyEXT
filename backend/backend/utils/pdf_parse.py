        ...
        for span_blocks, char_block in group_blocks:
            ...
            for line_index, line in enumerate(span_blocks['lines']):
                ...
                for span_index, span in enumerate(line['spans']):
                    ...
                    span_chars = [_char for _char in span_chars if _char['c'].strip()]
                    line['text'] += span['text']
...
def test_single():
    ...
    file_path = r'E:\workplace\daily_work\pdf2json\input\all_test\wKgBnGN1y9-AKqH_AADGyPxqkVw187.pdf'
    ...
    output_dir = r'E:\workplace\daily_work\pdf2json\output\all_test'
