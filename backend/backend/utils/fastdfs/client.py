...
class FDFS(object):
    ...
    def download_to_buffer(self, remote_file_id, offset=0, down_bytes=0):
        ...
        ret_download = self.client.download_to_buffer(remote_file_id, offset=offset, down_bytes=down_bytes)
        return ret_download
...
if __name__ == "__main__":
    ...
    upload_file = "/home/devcm/Downloads/rebuild/ocr/test/300972.jpg"

    file_id = "group1/M00/01/8D/wKgBiGYt_TuADjedAABvsWd-cHA28.json"
    # download_file = "rBIHD2NEwYWAAPk8AAHe_qBq8g0823.pdf"
    # download_file = "download_ATQLIAAKS0hbSUZg977.jpg"
    # file_id = "group1/M00/00/93/wKgBSWIEi2-ATQLIAAKS0hbSUZg977.png"

    # 远程机器
    # file_id = "group1/M00/00/93/wKgBSWIErDKAaIa4AAKS0hbSUZg220.png"

    fdfs = FDFS()
    
    # 测试下载
    # aa = fdfs.download_to_buffer("group1/M00/00/00/wKgBiGVxVEmAXYMWAAPXUTTCAHs031.jpg")
    # Content = aa['Content']
    # with open("11.jpg","wb") as f:
    #     f.write(Content)
    
    # 测试上传 
    # p = "/home/reno/idp_ocr/file/test_dir/测试文字越线表格.png"
    # aa = fdfs.upload(p)
    # f = open(p,"rb")
    # bytes_c = f.read()
    bb = fdfs.download_to_buffer(file_id)
    # bb = fdfs.upload_by_buffer(file_id)
    # print(aa)
    print(bb)

   
#    result = fdfs.upload(upload_file)
    # print('下载')
    # result = fdfs.download(download_file, file_id)
    # result = fdfs.download_to_buffer(file_id)
    # print(result)
    # multy_test()
    # download >>
